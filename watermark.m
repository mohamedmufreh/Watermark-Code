...
W_resized = imresize(W_BW,[M,N]);  % resizing the watermark image to be as the original image     
Iw = bitset (I,1,W_resized);                   % Now we replace the lowest bit in the original image using bitset function 
  %%%%%%%%%%%%%%%%%  
